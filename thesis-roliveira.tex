...
\newcommand{\namethesisen}{Monitoring and control system for the production of Salicórnia in the estuary of Aveiro}
...
\TitlePage
	...
	{cultivo da salicórnia, sensores, monitorização,  atuadores, atuação remota, plataforma web, plataforma mobile, sistema de vídeo-vigilância}
  	\vspace*{5mm}
  \TEXT{\textbf{resumo}}
