...
\begin{table}[]
	...
	\begin{tabular}{|
		...
		\textbf{Permisson} & id (auto-incrementado) & N/A & \begin{tabular}[c]{@{}l@{}}Possui todas as permissões\\  existentes (escrita, leitura\\  e remoção)\end{tabular} \\ \hline
...
\begin{table}[]
	...
	\begin{tabular}{|
		...
		\textbf{AlarmsSettings} & id (auto-incrementado) & id\_sensor & \begin{tabular}[c]{@{}l@{}}Permite guardar as configurações \\ para um determinado \\ sensor (valor máximo e mínimo)\end{tabular} \\ \hline
